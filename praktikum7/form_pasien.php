    ...
    <div class="container mt-5">
        ...
        <form action="proses_pasien.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <?php
                        $sqlkelurahan_id = "SELECT * FROM kelurahan";
                        $rskelurahan_id = $dbh->query($sqlkelurahan_id);
                    ?>

                    <select id="kelurahan_id" name="kelurahan_id" class="custom-select">
                        <?php
                            foreach ($rskelurahan_id as $rowkelurahan_id) {
                        ?>
                    <option value="<?= $rowkelurahan_id['id'] ?>"><?= $rowkelurahan_id['nama'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
